      ...
      <div className="mt-8 sm:mx-auto sm:w-full sm:max-w-md">
        <div className="bg-white py-8 px-4 shadow sm:rounded-lg sm:px-10">
          <form className="space-y-6" onSubmit={handleSubmit}>
            <div>
              ...
              <input
                ...
                className="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-black focus:border-orange-500 sm:text-sm"
              />
            </div>
            {message && (
            ...
            <div>
              <button
                type="submit"
                disabled={loading}
                className="w-full flex justify-center py-2 px-4 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-black hover:bg-black disabled:opacity-60"
              >
          ...
          <div className="mt-6 text-center text-sm">
            <Link href="/login" className="text-black hover:text-black">Back to sign in</Link>
          </div>
        </div>
      </div>
    </div>
