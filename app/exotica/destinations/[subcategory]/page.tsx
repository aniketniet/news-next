...
export default async function DestinationsSubcategoryPage({ params }: PageProps) {
  ...
  const subcategoryName = subcategoryMap[subcategory.toLowerCase()] || subcategory;
  const articles = getArticlesByCategory("Destinations", subcategoryName);
  const months = getMonthsForCategory("Destinations", subcategoryName);
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="mb-8">
            <nav className="text-sm text-gray-500 mb-4">
              ...
              <Link href="/exotica/destinations" className="hover:text-orange-600">Destinations</Link>
              <span className="mx-2">/</span>
            ...
            <h1 className="text-4xl md:text-5xl font-light text-gray-900 mb-2" style={{ fontFamily: 'serif' }}>
              Destinations - {subcategoryName}
            </h1>
            <p className="text-gray-600">Explore {subcategoryName.toLowerCase()} destinations and travel experiences</p>
          </div>
