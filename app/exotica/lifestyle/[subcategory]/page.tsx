...
export default async function LifestyleSubcategoryPage({ params }: PageProps) {
  ...
  const articles = getArticlesByCategory("Lifestyle", subcategoryName);
  const months = getMonthsForCategory("Lifestyle", subcategoryName);
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="mb-8">
            <nav className="text-sm text-gray-500 mb-4">
              ...
              <Link href="/exotica/lifestyle" className="hover:text-orange-600">Lifestyle</Link>
              <span className="mx-2">/</span>
