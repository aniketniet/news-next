...
export default function HospitalityPage() {
  const articles = getArticlesByCategory("Hospitality");
  const months = getMonthsForCategory("Hospitality");
      ...
      <main className="py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="mb-8">
            ...
            <p className="text-gray-600">Discover luxury stays and hospitality experiences</p>
          </div>
