                ...
                <article key={article.id} className="group">
                  <Link href={`/news/${article.urlKey || article.id}`} className="block">
                    <div className="bg-white border border-gray-200 overflow-hidden hover:shadow-md transition-shadow duration-200">
                      ...
                      <div className="p-4">
                        <h3 className="font-bold text-gray-900 group-hover:text-black transition-colors line-clamp-2 mb-2">
                          {article.title}
                        </h3>
                    ...
                    <Link href={`/news/${news.urlKey || news.id}`} className="block group">
                      <div className="flex gap-3">
                        ...
                        <div className="flex-1 min-w-0">
                          <div className="mb-1">
                            <span className="inline-block px-2 py-0.5 text-xs rounded font-semibold text-white bg-black">
                              {news.category}
                            </span>
                          </div>
                          <h3 className="font-semibold text-sm text-gray-900 group-hover:text-black transition-colors line-clamp-2 mb-1">
                            {news.title}
                          </h3>
