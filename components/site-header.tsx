...
export function SiteHeader() {
  ...
  // Preload E-PAPER data when the header mounts so it's ready on first hover/tap
  useEffect(() => {
        ...
        <div className="mx-auto flex max-w-7xl items-center justify-between px-4 h-9">
          ...
          <div className="flex items-center gap-4">
            ...
            <div className="flex items-center gap-2 text-white/80">
              <Link href="https://www.facebook.com/dailypioneer/" aria-label="Facebook" className="hover:text-white">
                <svg className="h-4 w-4" viewBox="0 0 24 24" fill="currentColor">
                  <path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z" />
                </svg>
              </Link>
              <Link href="https://x.com/TheDailyPioneer" aria-label="X" className="hover:text-white">
              ...
              <Link href="https://www.instagram.com/dailypioneer/" aria-label="Instagram" className="hover:text-white">
                <svg className="h-4 w-4" viewBox="0 0 24 24" fill="currentColor">
              ...
              if (category.label === "E-PAPER") {
                return (
                  ...
                  >
                    ...
                    {epaperOpen && (
                      <div className="absolute left-0 top-full mt-0.5 w-[min(92vw,360px)] max-h-[60vh] overflow-auto bg-white border shadow-lg rounded-md p-3 z-50">
                        {epaperLoading && (
                                ...
                                <div className="flex flex-col gap-1.5">
                                  {lang.locations.map((loc) => (
                                    <a
                                      ...
                                      className="flex items-center gap-2 rounded border border-gray-100 hover:border-gray-200 hover:bg-gray-50 px-2 py-1.5 text-sm"
                                    >
          ...
          <div className="border-t p-4">
            <div className="flex items-center justify-between">
              ...
              <div className="flex items-center gap-3">
                <Link href="https://www.facebook.com/dailypioneer/" aria-label="Facebook" className="text-gray-600">
                  <svg
                    className="h-5 w-5"
                    viewBox="0 0 24 24"
                    fill="currentColor"
                ...
                <Link href="https://x.com/TheDailyPioneer" aria-label="X" className="text-gray-600">
                  <svg
                    className="h-5 w-5"
                ...
                <Link href="https://www.instagram.com/dailypioneer/" aria-label="Instagram" className="text-gray-600">
                  <svg
                    className="h-5 w-5"
                    viewBox="0 0 24 24"
                    fill="currentColor"
