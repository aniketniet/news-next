    ...
    <header className="sticky top-0 z-50 w-full bg-white shadow-sm">
        ...
        <div className="mx-auto max-w-7xl px-4">
          <div className="flex items-center justify-between h-10 text-xs">
            <div className="flex items-center gap-4">
              <span className="text-gray-600">Wednesday, November 5, 2025</span>
            </div>
            <div className="flex items-center gap-4">
              {ready && (user ? (
                <ProfileDropdown />
              ...
              <div className="flex items-center gap-3 text-gray-600">
                <Link href="https://www.facebook.com/dailypioneer/" aria-label="Facebook" className="hover:text-black transition-colors">
                  <svg className="h-4 w-4" viewBox="0 0 24 24" fill="currentColor">
                    <path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z" />
                  </svg>
                </Link>
                <Link href="https://x.com/TheDailyPioneer" aria-label="X" className="hover:text-black transition-colors">
                ...
                <Link href="https://www.instagram.com/dailypioneer/" aria-label="Instagram" className="hover:text-black transition-colors">
                  <svg className="h-4 w-4" viewBox="0 0 24 24" fill="currentColor">
        ...
        <div className="mx-auto max-w-7xl px-4">
          <div className="flex items-center justify-between py-4">
            ...
            <div className="flex items-center gap-3 lg:flex-1">
              ...
              {/* Desktop Search Icon */}
              <button className="hidden lg:block text-gray-700 hover:text-black">
            ...
            {/* Right: Search Bar (Mobile/Tablet) */}
            <div className="flex items-center lg:flex-1 justify-end">
              <form
                onSubmit={onSearchSubmit}
                className="flex sm:flex items-center overflow-hidden rounded-full border border-gray-300 bg-white w-32 sm:w-48 lg:w-64"
              >
                <input
                  value={query}
                ...
                />
                <button type="submit" className="px-2 text-gray-600 hover:text-black">
      ...
      <nav className="hidden lg:block border-b border-gray-200">
        <div className="mx-auto max-w-7xl">
          <ul className="flex items-center justify-center px-4 text-xs font-semibold text-gray-800">
              ...
              if (category.label === "E-PAPER") {
                return (
                  ...
                  >
                    <button
                      type="button"
                      className="block px-3 py-3 hover:bg-gray-50 transition-colors whitespace-nowrap"
                    >
                      {category.label}
                    </button>

                    {epaperOpen && (
                      <div className="absolute left-0 top-full mt-0.5 w-[min(92vw,360px)] max-h-[60vh] overflow-auto bg-white border border-gray-200 shadow-lg rounded-md p-3 z-50">
                        {epaperLoading && (
                          ...
                          <div className="space-y-3">
                            {epaperData.map((lang) => (
                              <div key={lang.language}>
                                <div className="text-gray-800 font-semibold text-sm mb-1">{lang.language}</div>
                                <div className="flex flex-col gap-1.5">
                                  {lang.locations.map((loc) => (
                                    <a
                                      ...
                                      className="flex items-center gap-2 rounded border border-gray-100 hover:border-gray-300 hover:bg-gray-50 px-2 py-1.5 text-sm"
                                    >
        ...
        <div className="lg:hidden bg-white border-t border-gray-200">
          <div className="p-4 border-b border-gray-200">
            <form onSubmit={onSearchSubmit} className="flex gap-2">
              ...
              />
              <button type="submit" className="bg-[#FCCD04] text-black px-4 py-2 rounded text-sm font-medium hover:bg-yellow-300">
                Search
              </button>
            </form>
          </div>
          ...
          <div className="border-t border-gray-200 p-4">
            <div className="flex items-center justify-between">
              ...
              <div className="flex items-center gap-3">
                <Link href="https://www.facebook.com/dailypioneer/" className="text-gray-600">
                  <svg className="h-5 w-5" viewBox="0 0 24 24" fill="currentColor">
                    <path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z" />
                  </svg>
                </Link>
                <Link href="https://x.com/TheDailyPioneer" className="text-gray-600">
                  <svg className="h-5 w-5" viewBox="0 0 1200 1227" fill="currentColor">
                    <path d="M714.163 519.284L1160.89 0H1055.03L667.137 450.887L357.328 0H0L468.492 681.821L0 1226.37H105.866L515.491 750.218L842.672 1226.37H1200L714.137 519.284H714.163ZM569.165 687.828L521.697 619.934L144.011 79.6944H306.615L611.412 515.685L658.88 583.579L1055.08 1150.3H892.476L569.165 687.854V687.828Z" />
                  </svg>
                </Link>
                <Link href="https://www.instagram.com/dailypioneer/" className="text-gray-600">
                  <svg className="h-5 w-5" viewBox="0 0 24 24" fill="currentColor">
                    <path d="M12 2.163c3.204 0 3.584.012 4.85.07 3.252.148 4.771 1.691 4.919 4.919.058 1.265.069 1.645.069 4.849 0 3.205-.012 3.584-.069 4.849-.149 3.225-1.664 4.771-4.919 4.919-1.266.058-1.644.07-4.85.07-3.204 0-3.584-.012-4.849-.07-3.26-.149-4.771-1.699-4.919-4.92-.058-1.265-.07-1.644-.07-4.849 0-3.204.013-3.583.07-4.849.149-3.227 1.664-4.771 4.919-4.919 1.266-.057 1.645-.069 4.849-.069zm0-2.163c-3.259 0-3.667.014-4.947.072-4.358.2-6.78 2.618-6.98 6.98-.059 1.281-.073 1.689-.073 4.948 0 3.259.014 3.668.072 4.948.2 4.358 2.618 6.78 6.98 6.98 1.281.058 1.689.072 4.948.072 3.259 0 3.668-.014 4.948-.072 4.354-.2 6.782-2.618 6.979-6.98.059-1.28.073-1.689.073-4.948 0-3.259-.014-3.667-.072-4.947-.196-4.354-2.617-6.78-6.979-6.98-1.281-.059-1.69-.073-4.949-.073zm0 5.838c-3.403 0-6.162 2.759-6.162 6.162s2.759 6.163 6.162 6.163 6.162-2.759 6.162-6.163c0-3.403-2.759-6.162-6.162-6.162zm0 10.162c-2.209 0-4-1.79-4-4 0-2.209 1.791-4 4-4s4 1.791 4 4c0 2.21-1.791 4-4 4zm6.406-11.845c-.796 0-1.441.645-1.441 1.44s.645 1.44 1.441 1.44c.795 0 1.439-.645 1.439-1.44s-.644-1.44-1.439-1.44z" />
                  </svg>
                </Link>
